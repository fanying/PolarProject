...
def add2CurrentRaster(filename, folder = 'SAR/tiff/'):
...
def getLonLat(filename, folder = 'SAR/tiff/arcmapWorkspace/'):
...
def getProb(tiff_name, prob_folder = 'SAR/Proba/', ice_folder = 'SAR/Ice/', tiff_folder = 'SAR/tiff/arcmapWorkspace/'):
...
def putpixel(fname, folder = 'SAR/tiff/arcmapWorkspace/'):
...
def cropandmask(ulx, uly, lrx, lry, fname, folder = 'SAR/tiff/arcmapWorkspace/'):
    ...
    # lonlatfile = folder + fname + '_lonlat.mat'
    # probfile = folder + fname + '_prob.mat'
    # icefile = folder + fname + '_ice.mat'
